...
const winnerResults ={
  computer: ["Sorry!You Lost the game to a computer!", 'red'],
  player: ["Congratulations! You Win the game!!!!", 'blue'],
  tie: ["The game is a Tie!,Lets Try Again", 'pink']
}
...
function checkWinner() {
  if (compScore === 5 || playerScore === 5) {
    if (compScore === playerScore){
      ...
      let win = `${(compScore > playerScore) ? 'computer' : 'players'}`;
      updateWinner(win);
    }
  }
}
